...
//column 3 
wire sum0_2, carry0_2, cout0_2;
compressor4_2 cp01 (
        .x1(pp[3][0]), .x2(pp[2][1]), .x3(pp[1][2]), .x4(pp[0][3]), .cin(zero),
        .sum(sum0_2), .carry(carry0_2), .cout(cout0_2)
    );

//column 4
wire sum0_3, carry0_3, cout0_3;
compressor4_2 cp02 (
        .x1(pp[4][0]), .x2(pp[3][1]), .x3(pp[2][2]), .x4(pp[1][3]), .cin(cout0_2),
        .sum(sum0_3), .carry(carry0_3), .cout(cout0_3)
    );

//column 5
wire sum0_4, carry0_4, cout0_4;
compressor4_2 cp03 (
        .x1(pp[5][0]), .x2(pp[4][1]), .x3(pp[3][2]), .x4(pp[2][3]), .cin(cout0_3),
        .sum(sum0_4), .carry(carry0_4), .cout(cout0_4)
    );

//column 6
wire sum0_5, carry0_5, cout0_5;
compressor4_2 cp04 (
        .x1(pp[6][0]), .x2(pp[5][1]), .x3(pp[4][2]), .x4(pp[3][3]), .cin(cout0_4),
        .sum(sum0_5), .carry(carry0_5), .cout(cout0_5)
    );

//column 7
wire sum0_6, carry0_6, cout0_6;
compressor4_2 cp05 (
        .x1(pp[7][0]), .x2(pp[6][1]), .x3(pp[5][2]), .x4(pp[4][3]), .cin(cout0_5),
        .sum(sum0_6), .carry(carry0_6), .cout(cout0_6)
    );

//column 8
wire sum0_7, carry0_7, cout0_7;
compressor4_2 cp06 (
        .x1(zero), .x2(pp[7][1]), .x3(pp[6][2]), .x4(pp[5][3]), .cin(cout0_6),
        .sum(sum0_7), .carry(carry0_7), .cout(cout0_7)
    );

//column 9
wire sum0_8, carry0_8;
fa fa02 (.a(pp[7][2]), .b(pp[6][3]), .cin(cout0_7), .sum(sum0_8), .cout(carry0_8));

//---------------------------------------------------------------------------------------------//

//column 5
wire sum1_0, carry1_0;
ha ha02 (.a(pp[1][4]), .b(pp[0][5]), .sum(sum1_0), .cout(carry1_0)); 
...
//column 7
wire sum1_2, carry1_2, cout1_2;
compressor4_2 cp07 (
        .x1(pp[3][4]), .x2(pp[2][5]), .x3(pp[1][6]), .x4(pp[0][7]), .cin(zero),
        .sum(sum1_2), .carry(carry1_2), .cout(cout1_2)
    );

//column 8
wire sum1_3, carry1_3, cout1_3;
compressor4_2 cp08 (
        .x1(pp[4][4]), .x2(pp[3][5]), .x3(pp[2][6]), .x4(pp[1][7]), .cin(cout1_2),
...
ha ha03 (.a(sum0_1), .b(carry0_0), .sum(sum2_0), .cout(carry2_0)); 

//column 3
wire sum2_1, carry2_1;
ha ha04 (.a(sum0_2), .b(carry0_1), .sum(sum2_1), .cout(carry2_1)); 
...
//column 6
wire sum2_4, carry2_4, cout2_4;
compressor4_2 cp13 (
        .x1(sum0_5), .x2(carry0_4), .x3(sum1_1), .x4(carry1_0), .cin(zero),
        .sum(sum2_4), .carry(carry2_4), .cout(cout2_4)
    );

//column 7
wire sum2_5, carry2_5, cout2_5;
compressor4_2 cp14 (
        .x1(sum0_6), .x2(carry0_5), .x3(sum1_2), .x4(carry1_1), .cin(cout2_4),
        .sum(sum2_5), .carry(carry2_5), .cout(cout2_5)
    );

//column 8
wire sum2_6, carry2_6, cout2_6;
compressor4_2 cp15 (
        .x1(sum0_7), .x2(carry0_6), .x3(sum1_3), .x4(carry1_2), .cin(cout2_5),
...
compressor4_2 cp16 (
        .x1(sum0_8), .x2(carry0_7), .x3(sum1_4), .x4(carry1_3), .cin(cout2_6),
...
ha ha05 (.a(sum1_7), .b(carry1_6), .sum(sum2_10), .cout(carry2_10)); 

//column 13
wire sum2_11, carry2_11;
ha ha06 (.a(sum1_8), .b(carry1_7), .sum(sum2_11), .cout(carry2_11)); 

//column 14
wire sum2_12, carry2_12;
ha ha07 (.a(pp[7][7]), .b(carry1_8), .sum(sum2_12), .cout(carry2_12)); 
...
assign Sum[1]=sum0_0;
assign Sum[2]=sum2_0;
ha h08 (.a(sum2_1), .b(carry2_0), .sum(Sum[3]), .cout(Car[0]));
...
ha h09 (.a(carry2_12), .b(Car[11]), .sum(Sum[15]), .cout(Car[12]));
